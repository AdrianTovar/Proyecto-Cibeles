    ...
    throws ServletException, IOException {
       ICommand _beforeCommand=null;
        ...
        try {
            ...
            if (!operacion.equals("Login")&&!operacion.equals("MostrarLogin")&&!operacion.equals("ShowRegister"))
            {//El resto de operaciones requieren identificación
        ...
        catch (ProgException ex)
        {
            ...
            try{_beforeCommand.initPage(request, response);}catch(Exception e){};
